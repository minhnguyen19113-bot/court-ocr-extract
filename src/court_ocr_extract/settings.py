...
class PipelineSettings:
    ...
    vlm_model_name: str = "fake-vlm-contract"
...
def get_settings() -> PipelineSettings:
    ...
    return PipelineSettings(
        ...
        ocr_backend=_env("OCR_BACKEND", "tesseract"),
        ...
        enable_surya_ocr=_env_bool("ENABLE_SURYA_OCR", False),
        extractor_backend=_env("EXTRACTOR_BACKEND", "local_llm"),
        enable_local_llm_extraction=_env_bool("ENABLE_LOCAL_LLM_EXTRACTION", True),
        local_llm_provider=_env("LOCAL_LLM_PROVIDER", "ollama"),
        local_llm_model_name=_env("LOCAL_LLM_MODEL_NAME", "qwen3:4b"),
        local_llm_base_url=_env("LOCAL_LLM_BASE_URL", "http://127.0.0.1:11434"),
        local_llm_temperature=_env_float("LOCAL_LLM_TEMPERATURE", 0.0),
        local_llm_timeout_seconds=_env_float("LOCAL_LLM_TIMEOUT_SECONDS", 180.0),
        vlm_provider=_env("VLM_PROVIDER", "fake"),
        vlm_model_name=_env("VLM_MODEL_NAME", "fake-vlm-contract"),
        vlm_base_url=_env("VLM_BASE_URL", "http://127.0.0.1:11434"),
        vlm_temperature=_env_float("VLM_TEMPERATURE", 0.0),
        vlm_timeout_seconds=_env_float("VLM_TIMEOUT_SECONDS", 300.0),
