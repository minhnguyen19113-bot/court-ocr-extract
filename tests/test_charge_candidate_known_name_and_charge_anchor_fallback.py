...
def test_bounded_charge_candidate_requires_known_defendant_name_and_anchor() -> None:
    output = parse_explicit_decision_charges(
        [
            {
                "line_id": "p009_l0001",
                "source_region": DECISION_TAIL,
                "text": "Theo Quyết định, bị cáo Người Synthetic A về tội \"Charge Synthetic Alpha\".",
            }
        ],
